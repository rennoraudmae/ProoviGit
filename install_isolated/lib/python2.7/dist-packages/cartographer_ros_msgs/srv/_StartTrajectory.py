...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_4Bi().pack(_x.options.provide_odom_frame, _x.options.use_odometry, _x.options.use_laser_scan, _x.options.use_multi_echo_laser_scan, _x.options.num_point_clouds))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.options.provide_odom_frame, _x.options.use_odometry, _x.options.use_laser_scan, _x.options.use_multi_echo_laser_scan, _x.options.num_point_clouds,) = _get_struct_4Bi().unpack(str[start:end])
