...
class TrajectoryOptions {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.use_laser_scan = null;
      this.use_multi_echo_laser_scan = null;
      ...
      if (initObj.hasOwnProperty('use_laser_scan')) {
        this.use_laser_scan = initObj.use_laser_scan
      }
      else {
        this.use_laser_scan = false;
      }
      if (initObj.hasOwnProperty('use_multi_echo_laser_scan')) {
        this.use_multi_echo_laser_scan = initObj.use_multi_echo_laser_scan
      }
      else {
        this.use_multi_echo_laser_scan = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [use_laser_scan]
    bufferOffset = _serializer.bool(obj.use_laser_scan, buffer, bufferOffset);
    // Serialize message field [use_multi_echo_laser_scan]
    bufferOffset = _serializer.bool(obj.use_multi_echo_laser_scan, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [use_laser_scan]
    data.use_laser_scan = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [use_multi_echo_laser_scan]
    data.use_multi_echo_laser_scan = _deserializer.bool(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.use_laser_scan !== undefined) {
      resolved.use_laser_scan = msg.use_laser_scan;
    }
    else {
      resolved.use_laser_scan = false
    }

    if (msg.use_multi_echo_laser_scan !== undefined) {
      resolved.use_multi_echo_laser_scan = msg.use_multi_echo_laser_scan;
    }
    else {
      resolved.use_multi_echo_laser_scan = false
    }
