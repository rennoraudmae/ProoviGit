...
(cl:defclass <TrajectoryOptions> (roslisp-msg-protocol:ros-message)
  ((tracking_frame
   ...
   (use_odometry
    ...
    :initform cl:nil)
   (use_laser_scan
    :reader use_laser_scan
    :initarg :use_laser_scan
    :type cl:boolean
    :initform cl:nil)
   (use_multi_echo_laser_scan
    :reader use_multi_echo_laser_scan
    :initarg :use_multi_echo_laser_scan
    :type cl:boolean
    :initform cl:nil)
   (num_point_clouds
...
(cl:ensure-generic-function 'use_laser_scan-val :lambda-list '(m))
(cl:defmethod use_laser_scan-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cartographer_ros_msgs-msg:use_laser_scan-val is deprecated.  Use cartographer_ros_msgs-msg:use_laser_scan instead.")
  (use_laser_scan m))

(cl:ensure-generic-function 'use_multi_echo_laser_scan-val :lambda-list '(m))
(cl:defmethod use_multi_echo_laser_scan-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cartographer_ros_msgs-msg:use_multi_echo_laser_scan-val is deprecated.  Use cartographer_ros_msgs-msg:use_multi_echo_laser_scan instead.")
  (use_multi_echo_laser_scan m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TrajectoryOptions>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'use_laser_scan) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'use_multi_echo_laser_scan) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrajectoryOptions>) istream)
  "Deserializes a message object of type '<TrajectoryOptions>"
    ...
    (cl:setf (cl:slot-value msg 'use_laser_scan) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'use_multi_echo_laser_scan) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TrajectoryOptions>)))
  ...
  "622757fb530c57575d011a4b63ad3b48")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TrajectoryOptions)))
  "Returns md5sum for a message object of type 'TrajectoryOptions"
  "622757fb530c57575d011a4b63ad3b48")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TrajectoryOptions>))
  ...
  (cl:list 'TrajectoryOptions
    ...
    (cl:cons ':use_laser_scan (use_laser_scan msg))
    (cl:cons ':use_multi_echo_laser_scan (use_multi_echo_laser_scan msg))
